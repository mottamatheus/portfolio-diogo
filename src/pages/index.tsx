...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <motion.div
          className="flex flex-col items-start justify-start h-auto mt-14 md:mt-0 gap-4 md:justify-center md:items-center"
          initial={{ x: -100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 1 }}
        >
          <h1 className="text-4xl text-orange-500 mt-14 md:mt-0 dark:text-white md:text-6xl">
            Olá, <br /> me chamo
            <br /> Diogo Rocha
